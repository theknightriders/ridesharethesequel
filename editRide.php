              ...
              <div class="text-center">
                <div>Is this a repeat trip?</div>
                  <label class="radio-inline">
                    <input id="newTripRepeatBooleanYes" type="radio" value="yes"<?php if ($row['trip_repeat'] == 'yes'){echo "checked";} ?> name="oneOrRepeatTrip">Yes
                  </label>
                  <label class="radio-inline">
                    <input id="newTripRepeatBooleanNo" type="radio" value="no"<?php if ($row['trip_repeat'] == 'no'){echo "checked";} ?> name="oneOrRepeatTrip" >No
                  </label>
