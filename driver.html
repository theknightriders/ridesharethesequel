              ...
              <form id="newTripForm">
                <div class="row">
                  ...
                  <div class="col-sm-4 col-xs-8">
                    <div>
                        <p> Please click Schedule Trip when finished.</p>
                        <br> 
                    </div>
                    <div>
                      <input id="newTripDate" type="date" class="form-control" name="newTripDateInput" required>
                      <div class="input-group bootstrap-timepicker timepicker" required>
                      ...
                      <br><br>
                      <select class="selectpicker orangeDropdown form-control" data-width="100%" required>
                      ...
                      <div class="text-center">
                        ...
                        <div>
                        <br>
                        <p> Please note all packages must be smaller than a 10 inch x 13 inch envelope </p>
                        </div>
                      <div class="text-center">
